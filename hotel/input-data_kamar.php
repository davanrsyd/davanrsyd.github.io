...
input[type="submit"]:hover {
    ...
    <h3>Masukan Data Kamar</h3>
       <form method="post" action="input-aksi-data_kamar.php"><form>
        <table>
            <tr>
               <!-- <td>id_kamar</td>
...
<tr>
<td>tipe_kamar</td>
<td><input type="number" name="tipe_kamar"></td>
</tr>
...
<tr>
    <td>ketersediaan</td>
        <td><input type="number" name="ketersediaan"></td>
</tr>
